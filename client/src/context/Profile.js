...
function setProfileReducer(state, action){
    ...
    // const updatedcontactsMap = { ...state.contacts.contactsMap, ...contactsMap, };
    // const updatedAll = [ ...state.contacts.all, ...all ];
    // const updatedFavorite = [ ...state.contacts.favorite , ...favorite ];
    // const updatedRecent = [ ...state.contacts.recent, ...recent ];
