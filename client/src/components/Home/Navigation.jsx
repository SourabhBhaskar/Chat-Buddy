...
function Navigation() {
  ...
  return (
    <nav ref={navRef} className="w-full xl:w-[75px] h-[65px] xl:h-full flex xl:flex-col justify-between items-center order-1 xl:order-none flex-shrink-0 p-2 bg-light-nav dark:bg-dark-nav">
      {width >= 1280 && <div>
        <Icon
          icon={icons.logo}
          fontSize={40}
